...
def cadastrar_alunos():                                                                                                          #Declarando funcao para cadastrar os alunos.
    ...
    while cont < alunos:                                                                                                         #Enquanto contador for menor que alunos, repita
        ...
        n1 = validar_float(f"\nDigite a nota do {nome_aluno} no 1° bimestre: ")
        n2 = validar_float(f"Digite a nota do {nome_aluno} no 2° bimestre: ")
        n3 = validar_float(f"Digite a nota do {nome_aluno} no 3° bimestre: ")
        n4 = validar_float(f"Digite a nota do {nome_aluno} no 4° bimestre: ")
...
def validar_int(texto):
    while True:
        try:
            ...
            print("\nOpa! Digite um numero inteiro válido.")
...
def validar_float(texto):
    while True:
        try:
            ...
            print("\nOpa! Digite um numero decimal válido.")
